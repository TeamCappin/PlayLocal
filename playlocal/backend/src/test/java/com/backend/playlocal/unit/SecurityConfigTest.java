...
class SecurityConfigTest {
    ...
    @Test
    @DisplayName("Verify SecurityFilterChain bean is present (endpoint rules tested in integration)")
    void verifyEndpointSecurity() {
        // SecurityFilterChain is already asserted in securityFilterChainBeanExists.
        // Full endpoint security (e.g. /api/v1/endorsements vs /api/v1/games) is covered by integration tests.
        assertThat(context.getBean(SecurityFilterChain.class)).isNotNull();
    }
}
