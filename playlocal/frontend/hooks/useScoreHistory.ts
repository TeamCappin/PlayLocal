...
import { scoreHistoryApi, ScoreHistoryResponse, ScoreSummary, ScoreHistoryEntry } from '@/lib/api';
...
export function formatScoreReason(reason: string): { label: string; color: string; icon: string } {
    switch (reason) {
        case 'ATTENDANCE':
