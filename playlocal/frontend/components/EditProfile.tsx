        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          ...
          <form onSubmit={handleSave} className="space-y-8">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-2">
                This helps other players know what to expect when playing with
                you
              </p>
            </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {AVAILABILITY_OPTIONS.map((option) => {
                  ...
                  return (
                    ...
                    >
                      <Icon
                        className={`w-6 h-6 ${availability.includes(option.id) ? 'text-emerald-600' : 'text-gray-400'}`}
                      />
                      <span
            ...
            <div>
              ...
              <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
                ...
                <p className="text-sm text-gray-600 mt-2">
                  Based on your attendance and participation history
                </p>
              </div>
              <p className="text-sm text-gray-500 mt-2">
                This score is calculated automatically and cannot be edited
              </p>
            </div>
            ...
            <div className="border border-gray-200 rounded-xl">
              ...
              <p className="text-center text-sm text-gray-500 pb-4">
                See how other players will see your profile
              </p>
            </div>
