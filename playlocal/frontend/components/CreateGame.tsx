...
import { MapPin, Clock, Users, TrendingUp, Calendar, Save, Eye, Plus, X, Loader2, AlertCircle } from 'lucide-react';
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-gray-500">Enter precise location for players</span>
                    <a
...
function TimeSelect({ value, onChange, minTime }: { value: string, onChange: (val: string) => void, minTime?: string }) {
  const times = [];
  for (let i = 0; i < 24; i++) {
