...
export function ScoreHistoryList({
  ...
  const { history, summary, isLoading, error, hasMore, loadMore, refresh } =
    ...
    return (
      <div className="text-center py-8 text-gray-500">
        ...
        <p className="text-sm mt-1">
          Your reliability score changes will appear here.
        </p>
      </div>
    );
  }
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">
                {summary.attendedCount} attended · {summary.noShowCount}{' '}
                no-shows · {summary.gamesCount} total games
              </p>
            </div>
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="text-right">
                      <div
                        className={`text-lg font-semibold ${getDeltaColor(entry.delta)}`}
                      >
