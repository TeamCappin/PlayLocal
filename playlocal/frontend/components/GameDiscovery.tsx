...
const mockGames: GameResponse[] = [
  {
    ...
    location: {
      ...
      addressLine: '201 Rue Gary-Carter, Montréal, QC',
      city: 'Montreal',
      latitude: 45.5312,
      longitude: -73.6205,
    },
    ...
    endTime: new Date(
      Date.now() + 2 * 24 * 60 * 60 * 1000 + 7200000
    ).toISOString(),
    confirmedCount: 8,
    maxPlayers: 10,
    minPlayers: 6,
  ...
  },
  {
    ...
    sportName: 'Soccer',
    location: {
      name: 'Complexe Claude-Robillard',
      addressLine: '1000 Émile-Journault, Montréal',
      city: 'Montreal',
      latitude: 45.5401,
      longitude: -73.6241,
    },
    ...
    endTime: new Date(
      Date.now() + 3 * 24 * 60 * 60 * 1000 + 5400000
    ).toISOString(),
    confirmedCount: 12,
    maxPlayers: 22,
    minPlayers: 14,
  ...
  },
  {
    ...
    location: {
      name: 'Parc Jean-Drapeau Beach',
      addressLine: 'Île Sainte-Hélène',
      city: 'Montreal',
      latitude: 45.5088,
      longitude: -73.534,
    },
    ...
    endTime: new Date(
      Date.now() + 1 * 24 * 60 * 60 * 1000 + 10800000
    ).toISOString(),
    confirmedCount: 10,
    maxPlayers: 12,
    minPlayers: 8,
    ...
    organizer: {
      userId: 'd4e5f6a7-b890-1234-def0-456789012345',
      displayName: 'Omar E.',
      reliabilityScore: 92,
    },
    status: 'SCHEDULED',
  ...
  },
  {
    ...
    sportName: 'Tennis',
    location: {
      name: 'Parc Lafontaine Tennis',
      addressLine: 'Avenue du Parc Lafontaine',
      city: 'Montreal',
      latitude: 45.5256,
      longitude: -73.5698,
    },
    ...
    endTime: new Date(
      Date.now() + 4 * 24 * 60 * 60 * 1000 + 5400000
    ).toISOString(),
    confirmedCount: 3,
    maxPlayers: 4,
    minPlayers: 4,
    ...
    organizer: {
      userId: 'e5f6a7b8-9012-3456-ef01-678901234567',
  ...
  },
  {
    ...
    sportName: 'Badminton',
    location: {
      name: 'Centre sportif Côte-des-Neiges',
      addressLine: '4880 Avenue Van Horne',
      city: 'Montreal',
      latitude: 45.492,
      longitude: -73.6241,
    },
    ...
    endTime: new Date(
      Date.now() + 5 * 24 * 60 * 60 * 1000 + 7200000
    ).toISOString(),
    confirmedCount: 6,
    maxPlayers: 8,
    minPlayers: 4,
    ...
    organizer: {
      userId: 'f6a7b890-1234-5678-f012-890123456789',
      displayName: 'Younes B.',
      reliabilityScore: 94,
    },
    status: 'SCHEDULED',
    allowWaitlist: true,
  ...
  },
  {
    ...
    location: {
      ...
      addressLine: '4601 Rue Sherbrooke E',
      city: 'Montreal',
      latitude: 45.5569,
      longitude: -73.5497,
    },
    hasExactLocationAccess: true,
    startTime: new Date(
      Date.now() + 2 * 24 * 60 * 60 * 1000 + 3600000
    ).toISOString(),
    endTime: new Date(
      Date.now() + 2 * 24 * 60 * 60 * 1000 + 9000000
    ).toISOString(),
    confirmedCount: 10,
    maxPlayers: 14,
    minPlayers: 10,
    ...
    organizer: {
      userId: 'a7b89012-3456-789a-0123-012345678901',
      displayName: 'Alex G.',
      reliabilityScore: 96,
    },
    status: 'SCHEDULED',
  ...
  },
  {
    ...
    location: {
      name: 'McGill Stadium',
      addressLine: '475 Avenue des Pins O',
      city: 'Montreal',
      latitude: 45.5087,
      longitude: -73.5816,
    },
    ...
    endTime: new Date(
      Date.now() + 6 * 24 * 60 * 60 * 1000 + 5400000
    ).toISOString(),
    confirmedCount: 12,
    maxPlayers: 14,
    minPlayers: 10,
    ...
    organizer: {
      userId: 'b8901234-5678-9abc-1234-234567890123',
      displayName: 'David O.',
      reliabilityScore: 91,
    },
    status: 'SCHEDULED',
  ...
  },
  {
    ...
    location: {
      ...
      addressLine: 'Avenue du Mont-Royal',
      city: 'Montreal',
      latitude: 45.5163,
      longitude: -73.5854,
    },
    ...
    endTime: new Date(
      Date.now() + 7 * 24 * 60 * 60 * 1000 + 10800000
    ).toISOString(),
    confirmedCount: 14,
    maxPlayers: 18,
    minPlayers: 12,
    ...
    organizer: {
      userId: 'c9012345-6789-abcd-2345-456789012345',
      displayName: 'Steven Z.',
      reliabilityScore: 93,
    },
    status: 'SCHEDULED',
    allowWaitlist: true,
  ...
  },
  {
    ...
    sportName: 'Baseball',
    location: {
      name: 'Gary Carter Memorial Field',
      addressLine: 'Parc Jarry',
      city: 'Montreal',
      latitude: 45.5325,
      longitude: -73.618,
    },
    hasExactLocationAccess: true,
    startTime: new Date(
      Date.now() + 4 * 24 * 60 * 60 * 1000 + 7200000
    ).toISOString(),
    endTime: new Date(
      Date.now() + 4 * 24 * 60 * 60 * 1000 + 14400000
    ).toISOString(),
    confirmedCount: 12,
    maxPlayers: 18,
    minPlayers: 10,
    ...
    organizer: {
      userId: 'd0123456-789a-bcde-3456-678901234567',
      displayName: 'Youssef Y.',
      reliabilityScore: 89,
    },
    status: 'SCHEDULED',
    allowWaitlist: true,
  ...
  },
  {
    ...
    location: {
      name: 'YMCA du Parc',
      addressLine: '5550 Avenue du Parc',
      city: 'Montreal',
      latitude: 45.5214,
      longitude: -73.6058,
    },
    hasExactLocationAccess: true,
    startTime: new Date(
      Date.now() + 1 * 24 * 60 * 60 * 1000 + 3600000
    ).toISOString(),
    endTime: new Date(
      Date.now() + 1 * 24 * 60 * 60 * 1000 + 9000000
    ).toISOString(),
    confirmedCount: 6,
    maxPlayers: 8,
    minPlayers: 4,
    ...
    organizer: {
      userId: 'e1234567-89ab-cdef-4567-890123456789',
      displayName: 'Hudson L.',
      reliabilityScore: 88,
    },
    status: 'SCHEDULED',
    allowWaitlist: true,
  ...
  },
  {
    ...
    location: {
      ...
      addressLine: '1000 Avenue du Mont-Royal E',
      city: 'Montreal',
      latitude: 45.5271,
      longitude: -73.572,
    },
    hasExactLocationAccess: true,
    startTime: new Date(
      Date.now() + 5 * 24 * 60 * 60 * 1000 + 3600000
    ).toISOString(),
    endTime: new Date(
      Date.now() + 5 * 24 * 60 * 60 * 1000 + 9000000
    ).toISOString(),
    confirmedCount: 14,
    maxPlayers: 20,
    minPlayers: 12,
    ...
    organizer: {
      userId: 'f2345678-9abc-def0-5678-012345678901',
      displayName: 'Allaye D.',
      reliabilityScore: 99,
    },
    status: 'SCHEDULED',
    allowWaitlist: true,
