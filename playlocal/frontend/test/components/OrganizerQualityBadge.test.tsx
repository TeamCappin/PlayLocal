...
describe('OrganizerQualityBadge', () => {
  ...
  describe('Compact Variant', () => {
    it('should render OQS score in compact mode', async () => {
      render(<OrganizerQualityBadge userId="test-user-id" variant="compact" />);
  ...
  describe('Inline Variant', () => {
    it('should render OQS score inline', async () => {
      render(<OrganizerQualityBadge userId="test-user-id" variant="inline" />);
  ...
  describe('Full Variant', () => {
    ...
    it('should show game completion rate', async () => {
      render(<OrganizerQualityBadge userId="test-user-id" variant="full" />);
    ...
    it('should toggle info card explanation', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText('Good organizer with reliable game history')
        ).toBeInTheDocument();
        expect(
          screen.getByText('Game Completion Rate (60%)')
        ).toBeInTheDocument();
        expect(
          screen.getByText('Repeat Player Rate (40%)')
        ).toBeInTheDocument();
      });
    });
  });
