...
describe("Sidebar", () => {
  ...
  it("renders sidebar with right side", () => {
    ...
    const sidebar = container.querySelector('[data-slot="sidebar"][data-side="right"]');
    expect(sidebar).toBeInTheDocument();
  });
  ...
  it("renders sidebar with variant", () => {
    ...
    const sidebar = container.querySelector('[data-slot="sidebar"][data-variant="floating"]');
    expect(sidebar).toBeInTheDocument();
  });
});
...
describe("SidebarSeparator", () => {
  it("renders separator", () => {
    ...
    expect(screen.getByTestId("sep")).toHaveAttribute("data-slot", "sidebar-separator");
  });
});
